...
- Drag and drop verification still needs a live app pass to confirm uploader behavior, stepped navigation, and mixed-mode rendering work correctly inside Frappe.
