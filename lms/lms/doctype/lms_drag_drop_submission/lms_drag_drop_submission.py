...
class LMSDragDropSubmission(Document):
	def validate(self):
	...
	def validate_if_max_attempts_exceeded(self):
		max_attempts = frappe.db.get_value("LMS Drag Drop Activity", self.activity, "max_attempts")
		if max_attempts == 0:
			return
		...
		notification = frappe._dict(
			{
				...
				"email_content": _(
					"There has been an update on your drag and drop submission. Your latest score is {0}."
